      ...
      >
        ...
        <div className="flex flex-col mt-2 gap-1 py-2 px-3">
          ...
          <div className="flex justify-between">
            ...
            <span
              className={`flex md:gap-1 items-center text-xs font-bold ${
                isEggless ? "bg-red-700" : "bg-green-700"
              } rounded-full p-2 text-white/90`}
              aria-label={isEggless ? "Eggless product" : "Contains eggs"}
            >
              {isEggless ? (
                <Egg size={12} fill="white" color="white" />
              ) : (
                <EggOff size={12} fill="white" color="white" />
              )}
            </span>
          </div>
        </div>
